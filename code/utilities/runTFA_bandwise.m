function runTFA_bandwise(exp_cfg)
    ...
    for s = exp_cfg.subNums
        ...
        prepro_filename = ['PEP_WP4_EEG', num2str(s), '_timelock_reref_w.mat'];
        ...
        tf{1} = ft_freqanalysis(ft_cfg, timelock);
        ...
        tf{2} = ft_freqanalysis(ft_cfg, timelock);
        ...
        tf{3} = ft_freqanalysis(ft_cfg, timelock);
